...
Source: "..\scripts\instalacion\asegurar-env.ps1"; DestDir: "{app}\scripts"; Flags: ignoreversion
Source: "..\scripts\instalacion\limpiar-instalacion.ps1"; DestDir: "{app}\scripts"; Flags: ignoreversion
