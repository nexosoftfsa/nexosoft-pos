...
| 8    | **Funciones avanzadas de producto**: combos/promos y lotes/vencimientos. **8.1.a ✅** combos (producto compuesto: alta en catálogo + descuento de stock por componente al vender y al anular, en el cloud-api + ABM en el POS; ver [ADR-0033](docs/adr/0033-combos-producto-compuesto.md)) · **8.1.b** combo vendible offline-first en la pantalla de ventas · **8.2** lotes/vencimientos | 🚧 En curso |
| —    | Pendientes posteriores: CAE real ARCA (se integra con el primer cliente), funciones de negocio (lotes/vencimientos, combo offline en ventas), deploy (Railway) | ⏳ |
