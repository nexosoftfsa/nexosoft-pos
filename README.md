...
| 7    | **Sistema de gestión completo en el POS** (UI de la maqueta, real): catálogo, stock, caja, cuentas corrientes, comprobantes/NC, reportes y funciones avanzadas. Ver [roadmap Fase 7](docs/roadmap-fase-7-gestion.md). **7.1 ✅** shell + identidad visual + menú por rol · **7.2 ✅** catálogo (ABM online) · **7.3 ✅** stock (saldos, movimientos, historial) · **7.4 ✅** caja (turnos, arqueo, tesorería) · **7.5 ✅** cuentas corrientes (clientes + ledger) · **7.6 ✅** comprobantes y anulaciones (NC) · **7.7 ✅** reportes en el POS · **7.8** funciones avanzadas (**pago combinado ✅**, **recargos ✅**, **presupuestos ✅**, **remitos ✅**; **combos/promos y lotes/vencimientos → Fase 8**) | 🚧 En curso |
